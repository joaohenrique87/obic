    ...
    <section className="relative overflow-hidden bg-slate-900 py-20 md:py-32 min-h-[850px] flex items-center">
      ...
      <div className="container relative z-30">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-4 text-2xl font-bold tracking-tight text-white sm:text-3xl md:text-4xl max-w-2xl mx-auto text-center opacity-50">
            Observatório de Indicadores Culturais e Inovação em Dados
          </h1>

          <p className="mb-8 text-sm text-white/90 md:text-base max-w-xl mx-auto text-center opacity-50">
